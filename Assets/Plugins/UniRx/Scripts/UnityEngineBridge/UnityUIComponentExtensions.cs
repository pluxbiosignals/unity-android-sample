...
namespace UniRx
{
    public static partial class UnityUIComponentExtensions
    {
		...
		public static IDisposable SubscribeToActive(this IObservable<bool> source, GameObject gameObject)
		{
			return source.SubscribeWithState(gameObject, (x, s) => s.SetActive(x));
		}
